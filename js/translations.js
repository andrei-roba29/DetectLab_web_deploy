        ...
        const translations = {
            en: {
                ...
                // ── PWA install flow (Android) ──
                // Samsung Internet and several OEM browsers mint a WebAPK that
                // Google Play Protect reports as unsafe and blocks, so those
                // users are routed to Chrome, whose install flow is unaffected.
                pwa_help_title_chrome: 'Install from Chrome (recommended)',
                pwa_help_body_chrome: 'You are using {browser}. That browser builds an Android app which Google Play Protect incorrectly reports as unsafe and blocks. Chrome builds a signed, up-to-date app instead — the install takes a few seconds.',
                pwa_help_step_chrome_1: 'Tap <strong>Open in Chrome</strong> below.',
                pwa_help_step_chrome_2: 'In Chrome, tap <strong>Install</strong> in the banner at the bottom (or the ⋮ menu → <strong>Install app</strong>).',
                pwa_help_step_chrome_3: 'DetectLab appears on your home screen and opens full screen.',
                pwa_help_title_manual: 'Manual installation',
                pwa_help_body_manual: 'The browser has not offered the automatic install prompt yet. Use the browser menu:',
                pwa_help_step_manual_1: 'Open the browser menu (⋮ or ≡).',
                pwa_help_step_manual_2: 'Tap <strong>Install app</strong> / <strong>Add to Home screen</strong>.',
                ...
                ios_modal_tip: 'Note: on iOS this only works in Safari (not Chrome or Firefox).',
                pwa_help_title_desktop: 'Install on your computer',
                pwa_help_body_desktop: 'DetectLab also works as an app on desktop.',
                pwa_help_step_desktop_1: 'In Chrome or Edge, click the install icon at the right end of the address bar.',
                pwa_help_step_desktop_2: 'Or open the menu ⋮ → <strong>Install DetectLab</strong>.',
                pwa_help_tip_protect: '<strong>Seeing “Unsafe app blocked”?</strong> That warning comes from the Android wrapper built by the browser, not from DetectLab. Tap <strong>More details</strong> → <strong>Install anyway</strong>, or install from Chrome instead.',
                pwa_help_open_chrome: 'Open in Chrome',
                pwa_help_copy_link: 'Copy link',
                pwa_help_retry: 'Try again',
                pwa_help_close: 'Close',
                pwa_browser_samsung: 'Samsung Internet',
                pwa_browser_oem: 'this browser',
                pwa_browser_firefox: 'Firefox',
                pwa_browser_generic: 'this browser',
                pwa_toast_installed: '<strong>DetectLab installed.</strong> You will find it on your home screen.',
                pwa_toast_already: '<strong>Already installed.</strong> The DetectLab app is on this device.',
                pwa_toast_link_copied: '<strong>Link copied.</strong> Paste it in Chrome to install the app.',
                pwa_banner_title: 'Almost there!',
                pwa_banner_desc: 'Tap the button below to add DetectLab to your home screen.',
                pwa_banner_btn: 'Install DetectLab',
                pwa_banner_wait: 'Preparing the installer…',
                pwa_banner_btn_help: 'How to install',
                btn_ios: 'iOS App',
                ...
                layer_sat_period_label: 'Historic',
                layer_sat_period_present: '2025',
                ...
                battles_desc_more: 'Details',
                battles_desc_less: 'Hide',
                ...
                archeo_desc: 'Statistical analysis · 1–10 km radius · purple pin',
                ...
                archeo_legend_low: 'Low Potential',
                ...
                arch_report_desc: '1–10 km radius · APM 2.0 + potential zones + LIDAR · PDF',
                ...
                arch_report_pdf_lang: 'PDF language:',
                arch_report_show_results: 'Show results on the map',
                arch_report_ignore_lidar: 'Ignore LIDAR Scanner results',
                arch_report_rej_lidar_ignored: 'LIDAR Scanner result excluded',
                arch_report_lidar_ignored_desc: 'LIDAR Scanner results were ignored: candidates within their 100 m rings were excluded. LIDAR contributed no score, bonus or APM exception.',
                ...
                arch_report_step_roads: 'Reading the Roman roads…',
                ...
                arch_report_row_roads: 'Roman roads',
                ...
                arch_report_roads_near: 'Roman road at {dist}',
                arch_report_roads_none: 'no Roman road nearby (no penalty)',
                ...
                arch_report_subtitle: 'DetectLab analysis in a {radius} km radius around the selected point',
                ...
                arch_report_area_value: '{radius} km radius · {area} km²',
                ...
                arch_report_cover_intro: 'Three DetectLab premium sources, scored together inside the chosen radius: APM 2.0, archaeological-potential zones from known sites, and LIDAR Scanner annotations. Mandatory exclusions are applied first. The shortlist is places worth walking with a detector — not a prediction of what is buried there.',
                ...
                arch_report_src_roads_state: '{n} road segments near the analysis circle',
                ...
                arch_report_src_pot_desc: 'The bubbles returned by the “archaeological potential” layer: the same dense score field and variable-radius bubbles displayed by that layer, computed for the report’s centre and selected radius from the RAN/CIMEC sites, density, distance and triangle quality.',
                ...
                arch_report_src_roads_title: 'Roman roads',
                arch_report_src_roads_desc: 'Mapped Roman roads from the AWMC / DARE layer. Proximity is a bonus only: a nearby road can raise the score, but the absence of roads never lowers it.',
                ...
                arch_report_score_formula: 'score = {wapm}% · APM 2.0 + {wpot}% · potential zone + {wlidar}% · LIDAR  (+ up to {wroads}% if a Roman road is nearby)',
                arch_report_weight_apm: 'Colour of the APM 2.0 pixel: blue 100%, green 85%, yellow 62%. Unreadable pixel: neutral 30%.',
                arch_report_weight_potential: 'Inside a potential zone: the score of that zone. Near one: that score attenuated by the distance. No zone in the area: no potential contribution (0%).',
                arch_report_weight_lidar: 'Annotated on the scanner: 100% (plus a bonus). Near an anomaly: proportional to the distance. Nothing near: LIDAR weight is omitted (no penalty).',
                arch_report_weight_roads: 'Bonus only. A Roman road within 1.5 km adds up to 12%, falling with distance. No nearby road: the score is unchanged.',
                ...
                arch_report_stat_roads: 'Roman-road segments near the circle',
                ...
                arch_report_pot_none_long: 'No potential zone is close enough to contribute ({n} zones inside the search radius), so the potential component contributes 0%.',
                ...
                arch_report_lidar_none_long: 'No LIDAR Scanner object is close to this point, so this component is omitted (no penalty).',
                arch_report_roads_section_title: 'Roman roads',
                arch_report_roads_near_long: 'The nearest mapped Roman road is {dist} away. This is a bonus: the score is raised proportionally to that proximity.',
                arch_report_roads_none_long: 'No mapped Roman road is close enough to add a bonus. The score is not reduced for that absence.',
                ...
                arch_report_period_none: 'No period could be derived from the records of the nearest known sites — their recorded dating is listed below.',
                arch_report_period_from_name: 'dating from the site name ({period}) — the database has no separate dating field',
                ...
                arch_report_sites_note: 'Distances are measured to the site geometry; for polygon sites, to the nearest point of their boundary. † = the period was read from the site name, because the database has no separate dating field. The links open the RAN / CIMEC record.',
                ...
                arch_report_fig_apm_title: 'APM 2.0 high-potential areas (Search Help style)',
                arch_report_fig_apm_caption: 'The high-potential APM 2.0 cells inside the analysis area — exactly the three classes the analysis accepts (blue, green, yellow) — polygonized the way the Search Help tool does and filled with their legend colour at 45% over the satellite image. The blue dashed circle is the search radius; the blue rings are the results.',
                arch_report_fig_apm_grid: 'APM 2.0 high-potential polygons',
                ...
                arch_report_legend_results: 'Blue dashed circle = the search radius. Blue rings = the returned results, labelled Result 1/2/3.',
            ...
            ro: {
                ...
                // ── Flux de instalare PWA (Android) ──
                // Samsung Internet și unele browsere OEM generează un WebAPK pe
                // care Google Play Protect îl raportează ca nesigur și îl
                // blochează, așa că utilizatorii sunt îndrumați spre Chrome,
                // unde instalarea nu este afectată.
                pwa_help_title_chrome: 'Instalează prin Chrome (recomandat)',
                pwa_help_body_chrome: 'Folosești {browser}. Acest browser construiește o aplicație Android pe care Google Play Protect o raportează incorect ca nesigură și o blochează. Chrome construiește o aplicație semnată, la zi — instalarea durează câteva secunde.',
                pwa_help_step_chrome_1: 'Apasă <strong>Deschide în Chrome</strong> mai jos.',
                pwa_help_step_chrome_2: 'În Chrome, apasă <strong>Instalează</strong> în banda de jos (sau meniul ⋮ → <strong>Instalează aplicația</strong>).',
                pwa_help_step_chrome_3: 'DetectLab apare pe ecranul principal și pornește pe tot ecranul.',
                pwa_help_title_manual: 'Instalare manuală',
                pwa_help_body_manual: 'Browserul nu a oferit încă invitarea automată la instalare. Folosește meniul browserului:',
                pwa_help_step_manual_1: 'Deschide meniul browserului (⋮ sau ≡).',
                pwa_help_step_manual_2: 'Apasă <strong>Instalează aplicația</strong> / <strong>Adaugă pe ecranul principal</strong>.',
                ...
                ios_modal_tip: 'Notă: pe iOS pasul funcționează doar în Safari (nu în Chrome sau Firefox).',
                pwa_help_title_desktop: 'Instalează pe calculator',
                pwa_help_body_desktop: 'DetectLab funcționează ca aplicație și pe desktop.',
                pwa_help_step_desktop_1: 'În Chrome sau Edge, apasă iconița de instalare din capătul din dreapta al barei de adrese.',
                pwa_help_step_desktop_2: 'Sau deschide meniul ⋮ → <strong>Instalează DetectLab</strong>.',
                pwa_help_tip_protect: '<strong>Vezi „Aplicație nesigură blocată”?</strong> Avertismentul vine de la ambalajul Android generat de browser, nu de la DetectLab. Apasă <strong>Mai multe detalii</strong> → <strong>Instalează oricum</strong>, sau instalează din Chrome.',
                pwa_help_open_chrome: 'Deschide în Chrome',
                pwa_help_copy_link: 'Copiază linkul',
                pwa_help_retry: 'Încearcă din nou',
                pwa_help_close: 'Închide',
                pwa_browser_samsung: 'Samsung Internet',
                pwa_browser_oem: 'acest browser',
                pwa_browser_firefox: 'Firefox',
                pwa_browser_generic: 'acest browser',
                pwa_toast_installed: '<strong>DetectLab instalat.</strong> Îl găsești pe ecranul principal.',
                pwa_toast_already: '<strong>Deja instalat.</strong> Aplicația DetectLab este pe acest dispozitiv.',
                pwa_toast_link_copied: '<strong>Link copiat.</strong> Lipește-l în Chrome pentru a instala aplicația.',
                pwa_banner_title: 'Aproape gata!',
                pwa_banner_desc: 'Apasă butonul de mai jos pentru a adăuga DetectLab pe ecranul principal.',
                pwa_banner_btn: 'Instalează DetectLab',
                pwa_banner_wait: 'Se pregătește instalarea…',
                pwa_banner_btn_help: 'Cum se instalează',
                ...
                layer_sat_period_label: 'Istoric',
                layer_sat_period_present: '2025',
                ...
                battles_desc_more: 'Detalii',
                battles_desc_less: 'Ascunde',
                ...
                archeo_desc: 'Analiză statistică · rază 1–10 km · pin mov',
                ...
                archeo_pot_mode_heat: 'Heatmap',
                archeo_legend_low: 'Potențial Scăzut',
                ...
                arch_report_desc: 'Rază 1–10 km · APM 2.0 + zone cu potențial + LIDAR · PDF',
                ...
                arch_report_pdf_lang: 'Limba PDF-ului:',
                arch_report_show_results: 'Arată rezultatele pe hartă',
                arch_report_ignore_lidar: 'Ignoră rezultate LIDAR Scanner',
                arch_report_rej_lidar_ignored: 'Rezultat LIDAR Scanner exclus',
                arch_report_lidar_ignored_desc: 'Rezultatele LIDAR Scanner au fost ignorate: candidații din cercurile lor de 100 m au fost excluși. LIDAR nu a contribuit la scor și nu a acordat bonusuri sau excepții APM.',
                ...
                arch_report_step_roads: 'Se citesc drumurile romane…',
                ...
                arch_report_row_lidar: 'LIDAR',
                arch_report_row_roads: 'Drumuri romane',
                arch_report_row_uat: 'UAT',
                ...
                arch_report_roads_near: 'drum roman la {dist}',
                arch_report_roads_none: 'niciun drum roman aproape (fără penalizare)',
                ...
                arch_report_subtitle: 'Analiză DetectLab pe o rază de {radius} km în jurul punctului ales',
                arch_report_badge_premium: 'PREMIUM',
                ...
                arch_report_area_value: 'Rază {radius} km · {area} km²',
                ...
                arch_report_cover_intro: 'Trei surse premium DetectLab, evaluate împreună în raza aleasă: APM 2.0, zonele cu potențial arheologic din siturile cunoscute și adnotările LIDAR Scanner. Excluderile obligatorii se aplică întâi. Lista scurtă indică locuri de parcurs cu detectorul — nu o predicție a ceea ce se află în pământ.',
                ...
                arch_report_src_roads_state: '{n} segmente de drum lângă cercul de analiză',
                ...
                arch_report_src_pot_desc: 'Bulele returnate de stratul „Zone cu potențial arheologic”: același câmp dens de scor și aceleași bule cu raze variabile afișate de strat, calculate pentru centrul și raza selectată în raport, pe baza siturilor RAN/CIMEC, densității, distanțelor și calității triangulării.',
                arch_report_src_lidar_title: 'LIDAR Scanner',
                ...
                arch_report_src_roads_title: 'Drumuri romane',
                arch_report_src_roads_desc: 'Drumurile romane cartografiate din stratul AWMC / DARE. Proximitatea este doar o bonificare: un drum aproape poate crește scorul, dar absența drumurilor nu îl scade niciodată.',
                ...
                arch_report_score_formula: 'scor = {wapm}% · APM 2.0 + {wpot}% · zonă cu potențial + {wlidar}% · LIDAR  (+ până la {wroads}% dacă există un drum roman aproape)',
                arch_report_weight_apm: 'Culoarea pixelului APM 2.0: albastru 100%, verde 85%, galben 62%. Pixel ilizibil: neutru 30%.',
                arch_report_weight_potential: 'Într-o zonă cu potențial: scorul acelei zone. Aproape de una: scorul ei atenuat cu distanța. Nicio zonă în arie: fără contribuție de potențial (0%).',
                arch_report_weight_lidar: 'Adnotat pe scanner: 100% (plus bonus). Aproape de o anomalie: proporțional cu distanța. Nimic aproape: ponderea LIDAR este omisă (fără penalizare).',
                arch_report_weight_roads: 'Doar bonificare. Un drum roman în 1,5 km adaugă până la 12%, descrescând cu distanța. Niciun drum aproape: scorul rămâne neschimbat.',
                ...
                arch_report_stat_roads: 'Segmente de drum roman lângă cerc',
                ...
                arch_report_pot_none_long: 'Nicio zonă cu potențial nu este suficient de aproape pentru a contribui ({n} zone în raza de căutare), deci componenta de potențial contribuie cu 0%.',
                ...
                arch_report_lidar_none_long: 'Niciun obiect LIDAR Scanner nu este aproape de acest punct, deci componenta este omisă (fără penalizare).',
                arch_report_roads_section_title: 'Drumuri romane',
                arch_report_roads_near_long: 'Cel mai apropiat drum roman cartografiat este la {dist}. Este o bonificare: scorul crește proporțional cu această proximitate.',
                arch_report_roads_none_long: 'Niciun drum roman cartografiat nu este suficient de aproape ca să adauge o bonificare. Scorul nu este redus pentru această absență.',
                ...
                arch_report_period_none: 'Nicio perioadă nu a putut fi derivată din înregistrările celor mai apropiate situri cunoscute — datările lor înregistrate sunt listate mai jos.',
                arch_report_period_from_name: 'datare preluată din numele sitului ({period}) — baza de date nu are un câmp separat de datare',
                ...
                arch_report_sites_note: 'Distanțele sunt măsurate până la geometria sitului; pentru siturile tip poligon, până la cel mai apropiat punct al conturului. † = perioada a fost citită din numele sitului, pentru că baza de date nu are un câmp separat de datare. Linkurile deschid fișa RAN / CIMEC.',
                ...
                arch_report_fig_apm_title: 'Zonele APM 2.0 cu potențial ridicat (stil Search Help)',
                arch_report_fig_apm_caption: 'Celulele APM 2.0 cu potențial ridicat din interiorul ariei analizate — exact cele trei clase acceptate de analiză (albastru, verde, galben) — poligonizate așa cum o face unealta Search Help și umplute cu culoarea din legendă la 45% peste imaginea satelitară. Cercul albastru punctat este raza de căutare; inelele albastre sunt rezultatele.',
                arch_report_fig_apm_grid: 'Poligoanele APM 2.0 cu potențial ridicat',
                ...
                arch_report_legend_results: 'Cerc albastru punctat = raza de căutare. Inele albastre = rezultatele returnate, etichetate Rezultat 1/2/3.',
