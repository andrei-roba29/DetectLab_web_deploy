        ...
        const translations = {
            en: {
                ...
                sat60_load_here: 'Search images here',
                sat60_zoom_more: 'Zoom in more',
                sat60_load_title: 'Search 1960s imagery for the visible area (zoom ≥ 11)',
                sat60_loading: 'Searching 1960s imagery for the visible area…',
                sat60_progress: 'Searching 1960s imagery… ({done}/{total})',
                sat60_progress_zoom: 'Searching 1960s imagery… zoom {z} ({done}/{total})',
                ...
                sat60_not_ready: 'The satellite layer is preparing… please try again in a few seconds.',
                sat60_zoom_hint: 'Zoom in to level 11 or more to search images here.',
            ...
            ro: {
                ...
                sat60_load_here: 'Caută imagini aici',
                sat60_zoom_more: 'Mărește mai mult',
                sat60_load_title: "Caută imagini satelitare anii '60 pentru zona vizibilă (zoom ≥ 11)",
                sat60_loading: 'Se caută imagini satelitare în zona vizibilă…',
                sat60_progress: 'Se caută imagini satelitare anii 1960… ({done}/{total})',
                sat60_progress_zoom: 'Se caută imagini satelitare anii 1960… zoom {z} ({done}/{total})',
                sat60_found: 'S-au găsit {n} imagini — există imagini satelitare în această zonă',
                sat60_no_images: 'Nu există imagini aici',
                sat60_error: 'Nu s-au putut căuta imaginile, încercați din nou.',
                sat60_not_ready: 'Stratul satelitar se pregătește… încercați din nou în câteva secunde.',
                sat60_zoom_hint: 'Mărește zoom-ul la nivelul 11 sau mai mult pentru a căuta imagini aici.',
                layer_banat: 'Banat - 1769-1772',
