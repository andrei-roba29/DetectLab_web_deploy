        ...
        const translations = {
            en: {
                ...
                archeo_legend_score: 'Score 0–100%',
                archeo_legend_excluded: 'UAT / heritage radius',
                archeo_hint: 'Every cell inside the radius is scored, so there are no gaps: bubbles or heatmap. Red = UAT built-up area and heritage protection radii (excluded).',
                ...
                arch_report_pot_none_long: 'No potential zone is close enough to contribute ({n} zones inside the search radius), so the component falls back to the neutral baseline.',
            ...
            ro: {
                ...
                archeo_legend_score: 'Scor 0–100%',
                archeo_legend_excluded: 'UAT / rază patrimoniu',
                archeo_hint: 'Fiecare celulă din rază primește scor, deci nu rămân goluri: bule sau heatmap. Roșu = intravilan UAT și razele de protecție ale siturilor (excluse).',
                ...
                arch_report_pot_none_long: 'Nicio zonă cu potențial nu este suficient de aproape ca să contribuie ({n} zone în raza de căutare), deci componenta revine la valoarea neutră.',
