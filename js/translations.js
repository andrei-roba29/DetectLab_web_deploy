        ...
        const translations = {
            en: {
                ...
                arch_report_src_roads_state: '{n} road segments near the analysis square',
                ...
                arch_report_stat_roads: 'Roman-road segments near the square',
                ...
                arch_report_fig_apm_caption: 'The high-potential APM 2.0 cells inside the analysis area — exactly the three classes the analysis accepts (blue, green, yellow) — polygonized the way the Search Help tool does and filled with their legend colour at 45% over the satellite image. The orange dashed square is the 5 km² analysis area; the orange polygons are the results.',
            ...
            ro: {
                ...
                arch_report_src_roads_state: '{n} segmente de drum lângă pătratul de analiză',
                ...
                arch_report_stat_roads: 'Segmente de drum roman lângă pătrat',
                ...
                arch_report_fig_apm_caption: 'Celulele APM 2.0 cu potențial ridicat din interiorul ariei analizate — exact cele trei clase acceptate de analiză (albastru, verde, galben) — poligonizate așa cum o face unealta Search Help și umplute cu culoarea din legendă la 45% peste imaginea satelitară. Pătratul portocaliu punctat este aria analizată de 5 km²; poligoanele portocalii sunt rezultatele.',
