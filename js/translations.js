        ...
        const translations = {
            en: {
                ...
                arch_report_avoid_lidar: 'Avoid LIDAR Scanner results',
                arch_report_avoid_lidar_hint: 'Skips the results returned only because they are annotated on LIDAR Scanner; the rest keep the normal score.',
                arch_report_avoid_lidar_note: 'LIDAR Scanner results avoided — only the candidates scored by the algorithm are shown.',
                arch_report_avoid_lidar_method: 'Option used for this report: the results that come entirely from the LIDAR Scanner — the annotated anomalies, which are otherwise returned automatically — were excluded. Every other candidate keeps the normal weighted score, LIDAR proximity included.',
                ...
                arch_report_rej_lidar_annotation_avoided: 'LIDAR Scanner result (option: avoid LIDAR Scanner results)',
            ...
            ro: {
                ...
                arch_report_avoid_lidar: 'Evită rezultatele LIDAR Scanner',
                arch_report_avoid_lidar_hint: 'Sunt sărite rezultatele returnate doar pentru că sunt adnotate pe LIDAR Scanner; restul păstrează scorul normal.',
                arch_report_avoid_lidar_note: 'Rezultatele LIDAR Scanner sunt evitate — sunt afișați doar candidații punctați de algoritm.',
                arch_report_avoid_lidar_method: 'Opțiune folosită pentru acest raport: au fost excluse rezultatele care provin în întregime din LIDAR Scanner — anomaliile adnotate, care altfel sunt returnate automat. Toți ceilalți candidați păstrează scorul ponderat normal, inclusiv proximitatea LIDAR.',
                ...
                arch_report_rej_lidar_annotation_avoided: 'Rezultat LIDAR Scanner (opțiune: evită rezultatele LIDAR Scanner)',
                arch_report_tbl_indicator: 'Indicator',
