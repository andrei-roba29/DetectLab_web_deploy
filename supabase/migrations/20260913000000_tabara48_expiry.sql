...
--
-- Migration 20260908000000 seeded TABARA48 with 48 hours of Premium, but its
-- redemption window ended on 13 September 2026. This follow-up changes the
-- window for databases where that migration has already been applied. A
-- redemption made through the end of 1 October 2026 (Bucharest time) still
-- grants 48 hours from the moment of redemption. Existing grants are not
-- changed.
--
